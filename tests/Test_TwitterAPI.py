...
from ffgetter.TwitterAPI import TwitterAPI, TwitterAPIEndpoint
...
logger = getLogger("ffgetter.TwitterAPI")
...
class TestTwitterAPI(unittest.TestCase):
    def _get_instance(self) -> TwitterAPI:
        ...
        with patch("ffgetter.TwitterAPI.TwitterAPI.get"):
    ...
    def test_wait_until_reset(self):
        with ExitStack() as stack:
            mock_logger = stack.enter_context(patch.object(logger, "debug"))
            mock_wait = stack.enter_context(patch("ffgetter.TwitterAPI.TwitterAPI._wait"))
    ...
    def test_request(self):
        with ExitStack() as stack:
            ...
            mock_oauth_get = stack.enter_context(patch("ffgetter.TwitterAPI.OAuth1Session.get"))
            mock_oauth_post = stack.enter_context(patch("ffgetter.TwitterAPI.OAuth1Session.post"))
            mock_oauth_delete = stack.enter_context(patch("ffgetter.TwitterAPI.OAuth1Session.delete"))
            mock_wait_until_reset = stack.enter_context(patch("ffgetter.TwitterAPI.TwitterAPI._wait_until_reset"))
            mock_wait = stack.enter_context(patch("ffgetter.TwitterAPI.TwitterAPI._wait"))
    ...
    def test_get(self):
        with ExitStack() as stack:
            mock_request = stack.enter_context(patch("ffgetter.TwitterAPI.TwitterAPI.request"))
    ...
    def test_post_tweet(self):
        with ExitStack() as stack:
            mock_post = stack.enter_context(patch("ffgetter.TwitterAPI.TwitterAPI.post"))
