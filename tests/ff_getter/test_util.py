...
from ff_getter.util import FFtype, Result, find_values
...
class TestUtil(unittest.TestCase):
    ...
    def test_FFtype(self):
        self.assertEqual("following", FFtype.following.value)
        self.assertEqual("follower", FFtype.follower.value)

    def test_find_values(self):
        cache_filepath: Path = Path("./tests/ff_getter/cache/find_values_sample.json")
        sample_dict: dict = orjson.loads(cache_filepath.read_bytes()).get("result")
